...
export const metadata: Metadata = {
  title: "تركيب زجاج سيكوريت حي الرانوناء | مؤسسة عالم الفن والهندسة - 0548980056",
...
export default function AlRanounaaPage() {
  const schema = {
    ...
    "@type": "LocalBusiness",
    "name": "مؤسسة عالم الفن والهندسة - تركيب زجاج حي الرانوناء",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg prose-blue max-w-none text-gray-700 leading-relaxed mb-10">
            <p>
              إذا كنت من سكان حي الرانوناء بالمدينة المنورة وتبحث عن خبراء لتفصيل وتركيب زجاج السيكوريت، فإن مؤسسة عالم الفن والهندسة هي وجهتك المثالية المضمونة. يعد الرانوناء من الأحياء التي تشهد تطوراً عمرانياً وسكنياً متسارعاً وتكثر فيه الفلل الحديثة والعمائر السكنية الجديدة التي تحتاج لكفاءات عالية في التنفيذ.
            </p>
            <p>
          ...
          <div className="bg-[#f0f4f8] rounded-2xl p-8 mb-12 border-r-4 border-[#c9a84c]">
            <h2 className="text-2xl font-bold text-[#1e4d8c] mb-6">لماذا تختار مؤسسة عالم الفن والهندسة لحي الرانوناء؟</h2>
