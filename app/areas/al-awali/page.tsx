      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg prose-blue max-w-none text-gray-700 leading-relaxed mb-10">
            <p>
              أهلاً بكم في مؤسسة عمر طلال، الشريك الموثوق لتنفيذ كافة أعمال زجاج السيكوريت في حي العوالي الراقي بالمدينة المنورة. نعي تماماً مستوى الرقي التي تتميز به عقارات ومباني العوالي، ولذلك نضع بصمتنا الخاصة في كل مشروع نتعامل معه ليتناسق مع هذا الطابع الفخم.
            </p>
            <p>
            ...
            <p>
              نمتلك في عمر طلال فريقاً مختصاً يجيد التعامل مع أرقى الديكورات، مع التزام تام بمواعيد التسليم والنظافة بعد إتمام العمل. الزجاج المستخدم هو سيكوريت مضاد للصدمات معتمد ومطابق لأعلى المواصفات القياسية السعودية، لضمان استدامته لسنوات طويلة دون تأثر.
            </p>
          </div>
